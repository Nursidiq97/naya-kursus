    ...
    return (
      ...
      (N.qsa = function (t, e) {
        ...
        return t.getElementById && s && r
          ...
          ? []
          : u.call(s && !r && t.getElementsByClassName ? (i ? t.getElementsByClassName(o) : t.getElementsByTagName(e)) : t.querySelectorAll(e));
      }),
    ...
    (function (e) {
      ...
      (h.href = t.location.href),
        ...
        (e.ajax = function (n) {
          ...
          m(s),
            s.crossDomain || ((u = r.createElement("a")), (u.href = s.url), (u.href = u.href), (s.crossDomain = h.protocol + "//" + h.host != u.protocol + "//" + u.host)),
            s.url || (s.url = t.location.toString()),
            (f = s.url.indexOf("#")) > -1 && (s.url = s.url.slice(0, f)),
            S(s);
          var c = s.dataType,
            p = /\?.+=\?/.test(s.url);
          if ((p && (c = "jsonp"), (s.cache !== !1 && ((n && n.cache === !0) || ("script" != c && "jsonp" != c))) || (s.url = T(s.url, "_=" + Date.now())), "jsonp" == c))
            return p || (s.url = T(s.url, s.jsonp ? s.jsonp + "=?" : s.jsonp === !1 ? "" : "callback=?")), e.ajaxJSONP(s, a);
          var P,
            d = s.accepts[c],
            g = {},
            b = function (t, e) {
          ...
          if (
            ...
            b("Accept", d || "*/*"),
            (d = s.mimeType || d) && (d.indexOf(",") > -1 && (d = d.split(",", 2)[0]), N.overrideMimeType && N.overrideMimeType(d)),
